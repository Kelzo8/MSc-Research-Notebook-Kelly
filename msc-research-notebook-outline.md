...
### Can we spot fake public comments generated by ChatGPT(-3.5, -4)? / Zaitsu & Jin 2024

- **Full IEEE/APA Citation:**
  Zaitsu, W., & Jin, M. (2024). Can we spot fake public comments generated by ChatGPT(-3.5, -4)?: Japanese stylometric analysis expose emulation created by one-shot learning. *PLOS ONE, 19*(3), e0299031. https://doi.org/10.1371/journal.pone.0299031

- **Why did you select this paper?**
  I selected this paper because it is directly about distinguishing human public comments from ChatGPT-generated comments.
  It is highly relevant to my topic because it studies fake public comments rather than general machine-generated text.

- **Key Findings & Methodology:**
  The authors compare human public comments with GPT-generated public comments using stylometric analysis and classification methods.
  The paper reports that GPT-generated comments can be distinguished from human comments with high accuracy using the feature set they tested.

- **Limitations/Weaknesses Identified:**
  The study is based on Japanese public comments, so the language and domain may limit direct transfer to my setting.
  The task is broader than my exact project if I decide to focus specifically on social-media-style comments.

- **Direct Connection to *Your* Project:**
  This is one of my strongest sources because it directly addresses AI-generated comments, which is central to my research question.
  It gives me a concrete example of comment-level detection and a useful benchmark for comparing classical methods against transformer-based approaches.

### MAGE: Machine-generated Text Detection in the Wild / Li et al. 2024

- **Full IEEE/APA Citation:**
  Li, Y., Li, Q., Cui, L., Bi, W., Wang, Z., Wang, L., Yang, L., Shi, S., & Zhang, Y. (2024). MAGE: Machine-generated Text Detection in the Wild. In *Proceedings of the 62nd Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)*, 36–53. Association for Computational Linguistics.

- **Why did you select this paper?**
  I selected this paper because it tests machine-generated text detection in realistic settings rather than only on narrow benchmark data.
  It is useful for understanding how detection systems behave when the input data varies by domain and writing style.

- **Key Findings & Methodology:**
  The paper builds a broad testbed using human writing and deepfake texts generated by different LLMs.
  It evaluates detector performance across multiple generation sources and text types to understand robustness in the wild.

- **Limitations/Weaknesses Identified:**
  The paper is broader than comment detection, so it does not focus specifically on online comments.
  As with many benchmark-based studies, performance may still depend on the generator and dataset used.
